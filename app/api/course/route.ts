...
async function fetchCourseInfo(code:string){
    const response=await axios.get('https://api.data.um.edu.mo/service/academic/course_catalog/all?course_code='+code.toUpperCase(), allowLegacyRenegotiationOptions)
